 ...
 * @param {() => Array<String>} getActionNames 获取动作名称的函数
 ...
 * @param {()=>void} action 动作执行函数
 * @param {number} runtimes 初始运行次数
 * @param {number} waitTime 动作执行后的等待时间，单位为毫秒
 ...
 *
 * @param {GlobalObjects} globalObjects
